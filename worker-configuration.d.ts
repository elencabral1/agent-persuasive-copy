/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c571581662e1fecae7f7703c0b9ada4a)
// Runtime types generated with workerd@1.20250424.0 2025-02-04 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		OPENAI_API_KEY: string;
		AGENT_PERSUASIVE_COPY: DurableObjectNamespace<import("./src/server").AgentPersuasiveCopy>;
	}
}
